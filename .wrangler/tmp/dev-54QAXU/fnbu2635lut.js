...
// .wrangler/tmp/bundle-85gxjc/checked-fetch.js
...
// .wrangler/tmp/pages-vUXN1s/bundledWorker-0.17378364345685582.mjs
...
async function N(e, { request: t, assetsFetcher: a, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = S(await a.fetch(L(c, e.path ?? n))), e.headers && y(r.headers, e.headers);
        break;
      }
      case "static": {
...
function de(e, t) {
  ...
  let d = e.headers.get("Accept") ?? "", _ = t?.formats?.find((w) => d.includes(w))?.replace("image/", "");
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let i = globalThis[_e], r = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
...
var E = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: n } } = t, i = n && this.cookies[n], r = A(i ?? ""), o = A(this.reqCtx.request.headers.get("accept-language") ?? ""), d = [...r, ...o].map((_) => s[_]).filter(Boolean)[0];
    if (d) {
...
// .wrangler/tmp/pages-vUXN1s/fnbu2635lut.js
...
// .wrangler/tmp/bundle-85gxjc/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-85gxjc/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=fnbu2635lut.js.map
