...
var ce = /* @__PURE__ */ __name((e, t, a, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !oe.call(e, n) && n !== a && V(e, n, { get: /* @__PURE__ */ __name(() => t[n], "get"), enumerable: !(s = re(t, n)) || s.enumerable });
  return e;
}, "ce");
var $ = /* @__PURE__ */ __name((e, t, a) => (a = e != null ? ae(ie(e)) : {}, ce(t || !e || !e.__esModule ? V(a, "default", { value: e, enumerable: true }) : a, e)), "$");
var g;
var u = M(() => {
  g = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.33502310631119026.mjs.map
