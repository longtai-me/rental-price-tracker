...
var F = /* @__PURE__ */ __name((e, t, a) => (a = e != null ? ae(ie(e)) : {}, ce(t || !e || !e.__esModule ? H(a, "default", { value: e, enumerable: true }) : a, e)), "F");
var g;
var u = M(() => {
  g = { collectedLocales: [] };
});
...
function xe() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await Y(a), s) ? s : (we(a), e(a));
  };
}
__name(xe, "xe");
async function Re(e) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.43587126639536533.mjs.map
