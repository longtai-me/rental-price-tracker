...
var E = class {
  ...
  getLocaleFriendlyRoute(t, a) {
    return !this.locales || a !== "miss" ? t : K(t.src, this.locales) ? { ...t, src: t.src.replace(/\/\(\.\*\)\$$/, "(?:/(.*))?$") } : t;
  }
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.7726023323237959.mjs.map
